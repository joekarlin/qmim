...
# 	company=`pcregrep -o1 '<div class="yfi_rt_quote_summary" id="yfi_rt_quote_summary"><div class="hd"><div class="title"><h2>([A-Za-z0-9.,&!\s\;-]+)\s\(' $file`
	...
	company=`pcregrep -o1 '<div class="yfi_rt_quote_summary" id="yfi_rt_quote_summary"><div class="hd"><div class="title"><h2>(.+)\s\(' $file`
	
	if [ -z "$company" ]; then echo $ticker >&2; return; fi
